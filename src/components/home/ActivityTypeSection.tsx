...
export function ActivityTypeSection() {
  ...
  const activityTypes = ['Popular', 'Hiking', 'Surfing', 'Mountain', 'History'];
        ...
        <div className="text-center mb-10">
          ...
          <div className="flex justify-center text-center flex-wrap gap-2 mt-6">
            {activityTypes.map((type, idx) => (
              <span
                key={type}
                className={`inline-flex items-center justify-center px-5 py-2.5 rounded-[30px] h-[34px] text-sm border cursor-pointer transition-colors ${idx === activeTab
